...
public class PersonalUser implements Identity, Serializable {
	...
	/**
	 * 获取用户状态 1，正常状态，2，黑名单，3，已经删除
	 *
	 * @return status - 用户状态 1，正常状态，2，黑名单，3，已经删除
	 */
	...
	/**
	 * 设置用户状态 1，正常状态，2，黑名单，3，已经删除
	 *
	 * @param status 用户状态 1，正常状态，2，黑名单，3，已经删除
	 */
